      ...
      <div id="tanchuangbox" v-if="tanchuangboxdata">
        ...
        <div class="content">
          ...
          <ul class="contenttitle clearfloat" v-for="(item,index) in popupdatatanchuang">
            ...
            <!--<li v-if="item.testType==1">普通测试</li>-->
            ...
            <li v-if="item.scheme!=null">
              <span v-if="item.scheme!=0">    {{ (((item.scheme).toString().replace('+2,undefined','')).replace('2,','2.0')).replace('1,','1.0') }}	</span>
              <span v-if="item.scheme==0">暂未选配方</span>
            </li>
...
//        $(".hoverLogout").fadeIn();
    ...
    methods: {
      ...
      chushihua: function () {
        ...
        $.ajax({
          type: "post",
          url: "http://ws2.unescn.com/wx/getwxResponse.json",
          dataType: 'json',
          data: {
      ...
      deleteanalyse: function (reportId, memberId) {
        ...
        if (mymessage == true) {
          $.ajax({
            ...
            url: "http://ws2.unescn.com/deleteSkinTestReport.json",
...
//        alert(createTime)
        ...
        //window.location.href=window.location.origin+'/#/oneWayAnalysisPage'
...
//          alert(id);
        ...
        if (mymessage == true) {
          ...
          $.ajax({
            type: "post",
//          url:"http://192.168.10.27:8887/memberPageInit.json",
            url: "http://ws2.unescn.com/deleteMember.json",
//          url:api.commonapi.memberPageInit,
            dataType: 'json',
//          beforeSend: function(xhr) {
//            xhr.withCredentials = true;
...
//        alert(that.employeeName)
        $.ajax({
          type: "post",
//          url:"http://192.168.10.27:8887/memberPageInit.json",
          url: "http://ws2.unescn.com/memberPageInit.json",
//          url:api.commonapi.memberPageInit,
          dataType: 'json',
//          beforeSend: function(xhr) {
//            xhr.withCredentials = true;
...
//            that.memberListlastTestTime=result;
      ...
      goclick: function () {
        ...
        $.ajax({
          type: "post",
          url: "http://ws2.unescn.com/selectMemberListByNameOrTelAndPage.json",
//          url:"http://ws2.unescn.com/selectMemberListByNameOrTelAndPage.json",
//          url:api.commonapi.memberPageInit,
          dataType: 'json',
//          beforeSend: function(xhr) {
...
//          url:"http://192.168.10.27:8887/getSkinTestReportListByMemberId.json",
          url: "http://ws2.unescn.com/getSkinTestReportListByMemberId.json",
...
//          url:"http://192.168.10.27:8887/wxScanGetUser.json",
          url: "http://ws2.unescn.com/wxScanGetUser.json",
...
//            url:"http://192.168.10.27:8887/saveMember.json",
            url: "http://ws2.unescn.com/saveMember.json",
