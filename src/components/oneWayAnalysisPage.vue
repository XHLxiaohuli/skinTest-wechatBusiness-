    ...
    <div id="commontop">
      <div class="main">
        ...
        <div class="title_rig1 icon_back" @click="fanhuiup">
          <img src="http://ws2.unescn.com/unes/img/icon_back.png">返回
        </div>
    ...
    <div class="main clearfloat">
      ...
      <div class="left">
        ...
        <div class="ceshishijian">
          ...
          <div class="shijian" @click="checkzhedate(index,i.id)" :class="i.id==reportId?'checkdate':''"
               v-for="(i,index) in testshijian">{{ i.date}}
          </div>
        </div>
      ...
      <div class="right">
        ...
        <div class="fenxibaogao clearfloat">
          <!--<div class="buttn_report" v-if="ver==1">-->
            <!--&lt;!&ndash;<router-link to='/yuanbenfenxibaogao' target=" _blank">原版分析报告</router-link>&ndash;&gt;-->
            <!--&lt;!&ndash;<a target="_blank" @click="analysereport">原版分析报告</a>&ndash;&gt;-->
            <!--<router-link tag="a" target="_blank" :to="{name:'yuanbenfenxibaogao',query:{reportId:reportId}}">原版分析报告</router-link>-->
            <!--&lt;!&ndash;<router-link tag="a" target="_blank" :to="{path: '/yuanbenfenxibaogao/' +'reportId'}">原版分析报告</router-link>&ndash;&gt;-->
          <!--</div>-->
          <!--<div class="buttn_report_new" v-if="ver==2">-->
            <!--&lt;!&ndash;<a v-link="{path: '/newProductRecommenderPage'}"></a>&ndash;&gt;-->
            <!--&lt;!&ndash;<router-link to='/newProductRecommenderPage' target=" _blank">新版分析报告</router-link>&ndash;&gt;-->
            <!--&lt;!&ndash;<a target="_blank" @click="newanalysereport">新版分析报告</a>&ndash;&gt;-->
          ...
          <!--<div v-if="ver!=1&&ver!=2">-->
            ...
            <!--<div class="buttn_report" >-->
              ...
              <!--&lt;!&ndash;<a target="_blank" @click="analysereport">原版分析报告</a>&ndash;&gt;-->
              <!--<router-link tag="a" target="_blank" :to="{name:'yuanbenfenxibaogao',query:{reportId:reportId}}">原版分析报告</router-link>-->
              <!--&lt;!&ndash;<router-link tag="a" target="_blank" :to="{name:'yuanbenfenxibaogao',query:{reportId:reportId}}">原版分析报告1</router-link>&ndash;&gt;-->
            <!--</div>-->
            <div class="buttn_report_new">
              ...
              <router-link tag="a" target="_blank" :to="{name:'newProductRecommenderPage',query:{reportId:reportId}}">分析报告</router-link>
            </div>
          <!--</div>-->
...
//          url: "http://192.168.10.27:8887/oneWayAnalysisPageInit.json?" + 'reportId=' + reportId,
          url: "http://ws2.unescn.com/oneWayAnalysisPageInit.json?" + 'reportId=' + reportId,
//          url: "http://ws2.unescn.com/oneWayAnalysisPageInit.json?" + 'reportId=' + reportId,
...
//          url: "http://192.168.10.27:8887/oneWayAnalysisPageInit.json?" + 'reportId=' + that.reportId,
          url: "http://ws2.unescn.com/oneWayAnalysisPageInit.json?" + 'reportId=' + that.reportId,
...
//          url: "http://192.168.10.27:8887/getReportTestTimeByMemberAndPage.json?" + 'memberId=' + that.memberId,
          url: "http://ws2.unescn.com/getReportTestTimeByMemberAndPage.json",
          dataType: 'json',
          data: {
