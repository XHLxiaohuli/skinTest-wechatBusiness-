...
//                 localStorage.setItem("towUserName",that.loginiphone)
//                 localStorage.setItem("towUserPas",that.loginpsw)
//                 $(".loading").show();
...
//           });
          ...
          // formData.append("name", this.loginiphone);
          // formData.append("pwd", this.loginpsw);
          ...
          $.ajax({
            type: "post",
//            url: "http://ws2.unescn.com/login.json",
            url: "http://ws2.unescn.com/login.json",
